-- Sample reviews for imdb_clone database
-- These reference movies that should exist from the CSV data load

INSERT INTO reviews (movie_id, user_id, rating, comment_txt) VALUES
-- Reviews for The Shawshank Redemption (movie_id: 1)
...
-- Reviews for The Godfather (movie_id: 2)  
...
-- Reviews for The Dark Knight (movie_id: 3)
...
-- Reviews for Pulp Fiction (movie_id: 7)
...
-- Reviews for Inception (movie_id: 9)
...
-- Reviews for Fight Club (movie_id: 10)
...
-- Reviews for Forrest Gump (movie_id: 12)
...
-- Reviews for The Matrix (movie_id: 15)
...
-- Reviews for Goodfellas (movie_id: 16)
...
-- Reviews for Interstellar (movie_id: 23)
...
-- Note: These reviews assume movie_ids 1-23 correspond to the first movies in the CSV
-- In a real implementation, you'd want to verify the actual movie_ids from your database
